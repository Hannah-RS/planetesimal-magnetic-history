...
plt.legend()
ax2 = ax1.twinx()
plt.plot(t_plot1,Fs1,color='lightgreen',label=f'F$_s$ {model1}')
plt.plot(t_plot3,Fs3,color='darkgreen',linestyle='dotted',label=f'F$_s$ {model3}')
plt.plot(t_plot4,Fs4,color='turquoise',linestyle='-.',label=f'F$_s$ {model4}')
plt.plot(t_plot2,Fs2,color='limegreen',linestyle='dashed',label=f'F$_s$ {model2}')
