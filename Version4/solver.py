...
from parameters import  Myr, Tm0, Tc0, Ts, f0, r, rc, dr, kappa, kappa_c
...
"Need to check the expressions for all these functions or delete some of the files"

from parameters import km, kc, G, rhoc, alpha_c, cpc
...
Fcmb[:cond_i] = km*(Tc[:cond_i] - Tm_base[:cond_i])/d0[:cond_i] #expression for CMB flux in convective regime
...
var_list = [run, r, Tsolidus, Tm0, t_start/Myr, t_end_m, step_m/Myr, max(t)/Myr, cond_i, int_time]
