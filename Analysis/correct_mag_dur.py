...
threshold = 10
from parameters import save_interval_t, Myr, alpha_c, cpc, rhofe_s, rho_exp
...
for j in range(8):
    ...
    #add a unit row
    unit_row = ['','Myr','s','Myr','K','K','Myr','K','Myr','Myr','Myr','Myr','Myr','K','','Myr','T','Myr','','Myr','T','Myr','Myr','Myr','','Myr','Myr',''] #first row is units
